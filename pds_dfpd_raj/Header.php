        ...
        <div class="page-sidebar">
			...
			<ul class="x-navigation">
				...
				<li <?php echo ($current_page === 'OptimisedDataAll.php') ? 'class="active"' : ''; ?>>
					<a href="OptimisedDataAll.php" style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">PC to Warehouse Details</span></a>
				</li>
