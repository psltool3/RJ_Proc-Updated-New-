                                    ...
                                    <table id="export_table" class="table datatable">
                                        <thead>
                                            <tr>
												...
												<th style="font-size:15px">Available Capacity(Qtl)</th>
    ...
    <!-- START SCRIPTS -->
		...
		document.getElementById('downloadCSV').addEventListener('click', async function() {
			try {
				...
				downloadFile(csvBlob, 'Rajasthan_Warehouse_' + getDateString() + '.csv');
			} catch (error) {
		...
		document.getElementById('downloadXLSX').addEventListener('click', async function() {
			try {
				...
				downloadFile(excelBlob, 'Rajasthan_Warehouse_' + getDateString() + '.xlsx');
			} catch (error) {
		...
		document.getElementById('downloadPDF').addEventListener('click', async function() {
			try {
				...
				link.href = url;
				link.download = 'Rajasthan_Warehouse_' + getDateString() + '.pdf';
				link.click();
