...
try {
    ...
    $district = $name = $id = $latitude = $longitude = $wheat_procurement = $active = -1;
    ...
    while (($column = fgetcsv($file, 10000, ",")) !== FALSE) {
        ...
        if ($i == 0) {
            for ($j = 0; $j < count($column); $j++) {
                switch (trim($column[$j])) {
                    ...
                    case $reverseMapData["wheat_procurement"]: $wheat_procurement = $j; break;
        ...
        /* DATA ROW */
            ...
            if (!isNumber($column[$wheat_procurement])) {
