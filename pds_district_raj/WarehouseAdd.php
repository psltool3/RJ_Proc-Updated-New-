...
<script>
                             ...
                             <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
											...
											<div class="form-group">
                                                <label class="col-md-3 control-label">Available Capacity(Qtl)*</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                                        <input type="text" class="form-control" id="requirement" name="requirement" required />
                                                    </div>
                                                    <span class="help-block">Available Capacity</span>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Storage(Qtl)*</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                                        <input type="text" class="form-control" id="storage_capacity" name="storage_capacity" required />
                                                    </div>
                                                    <span class="help-block">Storage(Qtl)</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
											...
											<div class="form-group">
                                                <label class="col-md-3 control-label">Type of Warehouse</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
												   <span class="input-group-addon"><span class="fa fa-arrow-down"></span></span>
                                                    <select class="form-control select" id="warehousetype" name="warehousetype" required>
                                                    </select>
													</div>
    ...
    <!-- START SCRIPTS -->
        ...
        <!-- END PAGE PLUGINS -->
		<?php require('PreferenceAutocomplete.php');  ?>
