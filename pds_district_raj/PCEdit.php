...
if(isset($_POST["uid"])){
	...
	if($numrows!=0){
		...
		$wheat_procurement = $row['wheat_procurement'];
		$active = $row['active'];
	}
	else{
...
<script>
                                        ...
                                        <div class="col-md-6">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                                        <input type="number" step="any" class="form-control" id="wheat_procurement" name="wheat_procurement" value="<?php echo $wheat_procurement ?>" required oninput="this.value = this.value.replace(/[^0-9.]/g, '')" />
                                                    </div>
    ...
    <!-- START SCRIPTS -->
		...
		function showPopup() {
			...
			var wheat_procurement = document.getElementById('wheat_procurement').value;
            var district = document.getElementById('district').value;
            

            if (name === '' || latitude === '' || longitude === '' || id === '' || wheat_procurement === '' || district === '') {
