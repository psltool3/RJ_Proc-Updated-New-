...
$uid = $_POST['uid'];
$query = "SELECT * FROM preferences WHERE id='$uid'";
	...
	function verifyCaptcha() {
		...
		document.getElementById("password").value = encrypted;
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Preference Edit</li>
                </ul>
                <!-- END BREADCRUMB -->                       
                 ...
                 <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="api/PreferenceEdit.php" method="POST" class="form-horizontal">
                            <div class="panel panel-default">
                               <div class="panel-body">
                                    <p>Fill this form to Edit Preference.</p>
                                </div>
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control" id="preference" name="preference" required>
															<?php
															$used_prefs = [];
															$pref_query = "SELECT preference FROM preferences WHERE id != '$uid'";
