    ...
    <body>
        ...
        <div class="page-sidebar">
			...
			<ul class="x-navigation">
				<li class="xn-logo">
					<span style="font-size: 19px; text-align: center; margin: 10px;color:#fff">Rajasthan State Level</span>
				...
				<li <?php echo ($current_page === 'DistrictPerformance.php') ? 'class="active"' : ''; ?>>
					<a href="DistrictPerformance.php" style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">District Analysis PC to WH</span></a>
				</li>
				...
				<li <?php echo ($current_page === 'Performa.php') ? 'class="active"' : ''; ?>>
					<a href="Performa.php" style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">Performa Leg1</span></a>
				</li>
				...
				<li>
					<a href="Preference.php" style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">Edit Preferences</span></a>
				</li>
				<li>
