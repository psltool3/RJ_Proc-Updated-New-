...
files_to_update = [
    r'c:\xampp\htdocs\Rajasthan_Procurement\pds_admin_chat\api\BulkMillReplicaData.php',
    r'c:\xampp\htdocs\Rajasthan_Procurement\pds_admin_chat\api\BulkMillReplicaDataEdit.php'
]
