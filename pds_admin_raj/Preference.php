...
<style>
                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="panel-heading">
                                    <h3 class="panel-title">Preferences Data</h3>
                                </div>
								<a href="PreferenceAdd.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-success">Add New</button></a> 
                                    ...
                                    <table id="export_table" class="table datatable">
                                        <thead>
                                            <tr>
												...
												<th style="font-size:16px">Preference</th>
    ...
    <!-- START SCRIPTS -->
		...
		function edit_entry(temp_id){
			post({uid: temp_id} ,"PreferenceEdit.php");
		}
		...
		function VerifyAndDelete(){
			...
			post({uid: temp_id,username:username,password:encrypted} ,"api/PreferenceDelete.php");
		}
        ...
        $(document).ready(function() {
            if ($.fn.DataTable.isDataTable('#export_table')) {
                $('#export_table').DataTable().destroy();
            }
            $('#export_table').DataTable({
                "order": [[ 1, "asc" ]], // Default sort by Preference column (index 1)
                "columnDefs": [
                    { "orderable": false, "targets": [2, 3] } // Disable sorting for Edit and Delete columns
                ]
            });
        });
